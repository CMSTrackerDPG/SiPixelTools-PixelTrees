...
config.Data.outLFNDirBase = '/mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/kimj/PixelTrees/'
...
config.Site.storageSite = 'T3_US_Kansas' # or anything where you have access to
